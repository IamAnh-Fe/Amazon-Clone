...
ReactDOM.render(
    <React.StrictMode>
        <GoogleOAuthProvider clientId="86586470178-ng16g3jm7ncpo2tvq6m3bdojmnetns84.apps.googleusercontent.com">
            <BrowserRouter>
                <Provider store={store}>
                    <PersistGate loading={null} persistor={persistor}>
                        <Routes>
                            ...
                            <Route path="auth/sign-in/forgot-password" element={<ForgotPassword />}></Route>
